...
export TOK=${TOK:-'eyJhIjoiNzdiNzY1YmViZjhlMGRiZDAwZjg0MjRiOTM4NWI0ZGUiLCJ0IjoiMzAwNjk5ODYtMTcxMy00MGJhLTgxZGItODAzNmZjOTk1NDRkIiwicyI6Ik1UaGhZV1ppTlRFdFlUTmtaaTAwWWpOa0xUbGtabVF0WWpoaU5qaGlNbVU0WkdSaSJ9'}  # 隧道token或json
export ARGO_DOMAIN=${ARGO_DOMAIN:-'tyong.rg520.dpdns.org'} # 隧道域名
...
export UUID=${UUID:-'8586556b-da04-4f70-91f7-2292cbd335aa'} # 去掉#可以使用固定值，否则随机
