...
UUID = os.environ.get('UUID', '8586556b-da04-4f70-91f7-2292cbd335aa')  # UUID for cross-platform v1 nezha
...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'tyong.rg520.dpdns.org')          # Argo fixed tunnel domain, leave empty for temporary tunnel
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNzdiNzY1YmViZjhlMGRiZDAwZjg0MjRiOTM4NWI0ZGUiLCJ0IjoiMzAwNjk5ODYtMTcxMy00MGJhLTgxZGItODAzNmZjOTk1NDRkIiwicyI6Ik1UaGhZV1ppTlRFdFlUTmtaaTAwWWpOa0xUbGtabVF0WWpoaU5qaGlNbVU0WkdSaSJ9')              # Argo fixed tunnel token or json, leave empty for temporary tunnel
